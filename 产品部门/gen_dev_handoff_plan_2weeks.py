...
<body>
  <div class="top">
    <h1>产品 → 开发 · 原型与设计计划表</h1>
    <span class="meta">更新 08/18 晚 · 报价+风控 ✅ · 按组串行：船务→关务→海外</span>
    <div class="acts">
  ...
  <div class="wrap">
    ...
    <p class="foot">08/18 晚 · 按组串行：船务→关务→海外</p>
  </div>
</body>
</html>
"""
