...
> **附录 / 历史全文** — 权威需求口径已迁至 HTML 主册：[工单模块-需求PRD.html](工单模块-需求PRD.html)。本文保留完整背景与 BR 细则备查；冲突时以主册为准。

> **返回：** [← 旁支计划二导航](../../产品部门-导航.html#s-branch-connect) · [工单模块需求 PRD 主册](工单模块-需求PRD.html) · [旁支计划二总册 #9–#12](../../产品部门-旁支计划二-PRD.html#f9) · [计划二分册](工单系统-旁支计划二-PRD.html)
